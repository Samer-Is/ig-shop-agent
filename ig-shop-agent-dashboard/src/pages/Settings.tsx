          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-muted-foreground">
                  Get notified for new customer conversations
                </p>
              </div>
              <Switch />
            </div>
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-muted-foreground">
                  Get notified when AI responds to customers
                </p>
              </div>
              <Switch />
            </div>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-muted-foreground">
                  Enable automatic AI responses to customers
                </p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-muted-foreground">
                  Add realistic delay to AI responses
                </p>
              </div>
              <Switch defaultChecked />
            </div>
            <div className="space-y-2">
              ...
              <Input id="language" value="Jordanian Arabic" readOnly />
            </div>
          </CardContent>
        </Card>
      </div>
